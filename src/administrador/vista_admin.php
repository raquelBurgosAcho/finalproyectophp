        ...
        <aside id="menu1" class="h-screen w-1/5 bg-gray-800 text-white">
            ...
            <ul class="mt-6 space-y-4">
                ...
                <li class="py-2 px-4">
                    ...
                    <a href="permisos/permisos.php" class="flex items-center space-x-2">
        ...
        <section id="menu2" class="w-4/5 bg-gray-100">
            ...
            <div class="p-5 h-[80%] flex flex-col gap-6 mt-[70px] ">
                ...
                <div class="bg-white shadow-md rounded p-5 mt-4">
                    ...
                    <p class="text-gray-600 text-sm">Selecciona la acción que quieras realizar en la pestaña del menú de
                        la izquierda</p>
                </div>
            </div>
